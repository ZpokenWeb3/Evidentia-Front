...
import { BookUser, Hash, MapPin, StickyNote, User, UserSearch } from 'lucide-react';
    ...
    <div className='flex min-h-full flex-col gap-3 pb-6'>
      <div className='flex grow flex-col items-center rounded bg-background-secondary pb-7 pt-6  shadow-[0px_4px_4px_0px_#00000040]'>
        <div className='flex w-[524px] flex-col items-center gap-10'>
          <p className='text-xl font-semibold'>Know Your Customer (KYC) verification.</p>
          <form
            onSubmit={e => {
              e.preventDefault();
          ...
          >
            <div className='flex flex-col gap-4'>
              ...
              <InputIcon
                label='Last name'
                icon={<UserSearch className='size-5 stroke-2 text-input-icon' />}
