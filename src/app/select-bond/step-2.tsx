      ...
      <div className='flex flex-col justify-between'>
        <div className='flex flex-col gap-[76px]'>
          <p className='text-xl font-semibold'>
            Here is a simple collateral agreement to take your bonds as collateral and mint a
            tokenized version of your bonds.
          </p>
          <div className='flex flex-col gap-[60px]'>
            <div className='flex flex-col gap-4'>
              <div className='flex items-center gap-4'>
                ...
                <p className='text-base font-semibold'>Waiting your signature</p>
              </div>
              {step >= 1 && (
                <div className='flex items-center gap-4'>
                  {step === 1 ? (
                  ...
                  <p className='text-base font-semibold'>Awaiting verification</p>
                </div>
              )}
              {step >= 2 && (
                <div className='flex items-center gap-4'>
                  ...
                  <p className='text-base font-semibold'>Signed by both sides</p>
                </div>
              )}
            </div>
            {step >= 3 && <p className='text-base font-semibold'>Your bonds are ready to mint</p>}
          </div>
        </div>
        {step >= 3 && (
